...
while True:
    ...
    if (ligar_status and cafe_status):
        ...
        print("Cafe Pronto! Desligando em 3s...")
        ...
        agua_temp = agua_temp -30 # baixa a temperatura apenas para quando retornar ao comeco
        ...
        print ("Maquina Ligada! Pedindo Cafe em 3s...")
        ...
        print ("Maquina Desligada! Ligando em 3s...")
        time.sleep(3)
